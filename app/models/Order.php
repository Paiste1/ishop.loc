...
class Order extends AppModel
{
    ...
    public static function mailOrder($order_id, $user_email, $data){
        ...
        // письмо клиенту
        $message_client = (new Swift_Message("Вы совершили заказ №{$order_id} на сайте " . App::$app->getProperty('shop_name'))) // тема письма
        ...
        $message_admin = (new Swift_Message("Сделан заказ №{$order_id}")) // тема письма
        ->setFrom([App::$app->getProperty('smtp_login') => App::$app->getProperty('shop_name')])
