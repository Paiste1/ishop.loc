            ...
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    <div class="col-md-5 single-top-left">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li data-thumb="images/<?=$gal['img'];?>">
                                    <div class="thumb-image"> <img src="images/<?=$gal['img'];?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                </li>
                                <?php endforeach;?>
                            </ul>
                        </div>
                    ...
                    <?php
                        ...
                        $price_old = $product['old_price'] / $curr['value'];
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price"><?=$curr['symbol_left'];?><?=$price;?><?=$curr['symbol_right'];?></h5>
                            <?php if($product['old_price']): ?>
                                <del><?=$curr['symbol_left'];?><?=$price_old;?><?=$curr['symbol_right'];?></del>
                            <?php endif; ?>
                            <p><?=$product['content'];?></p>
                            <div class="available">
                                <ul>
                ...
                <div class="latestproducts">
                    <div class="product-one">
                        ...
                        <?php
                            ...
                            $price = number_format($price, 2, ',', '');
                            $price_old = $item['old_price'] / $curr['value'];
                            $price_old = number_format($price_old, 2, ',', '');
                        ?>
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <?php if($item['old_price']):?>
                                <?php
                                $sale = 100 - ($item['price'] * 100 / $item['old_price']);
