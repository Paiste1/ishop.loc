...
<head>
    ...
    <?php if($_SERVER['HTTP_HOST'] == 'ishop.master'){
        echo '<base href="/public/adminLTE/">';
    } else {
        echo '<base href="/adminLTE/">';
    }
    ;?>
    <link rel="shortcut icon" href="<?=PATH;?>/images/favicon.ico" type="image/png" />
    <?=$this->getMeta();?>
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014 - <?php echo date('Y');?> <a href="https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
        reserved.
    </footer>
